...
class AuthTest {
    ...
    @Test
    @DisplayName("Should successfully login with active registered user")       //Пользователь зарегистрирован и активен
    ...
    @Test
    @DisplayName("Should get error message if login with not registered user")   //Пользователь не зарегистрирован
